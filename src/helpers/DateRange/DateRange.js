        ...
        return (
            <div>
                <div className="rangePicker_Master">
                    ...
                    <div title={this.state.SelectRange} className="rangePicker_InpputIconAlign revenue" onClick={()=>this.setState({openDateRange:!this.state.openDateRange})}>
                        <Labelbox
                            type="text"
                            value={this.state.SelectRange}
                            placeholder={"\xa0" + "Start Date" + "\xa0\xa0\xa0" + "-- >" + "\xa0\xa0\xa0" + "End Date"} />
                        <InsertInvitationIcon className={`${this.props.changeMe ? "rangePicker_icon" : "rangePicker_Calendericon" }`} />
                    </div>
                </div>
