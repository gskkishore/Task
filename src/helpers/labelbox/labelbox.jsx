		...
		if (data.type == 'text') {
			return (
				<div className="formdiv">
					...
					<div>
						<input className={this.props.className ? this.props.className : "brdrcls"} value={this.props.value} maxLength={this.props.maxlength} placeholder={this.props.placeholder && this.props.placeholder} type="text" onChange={(e) => this.props.changeData && this.props.changeData(e.target.value)} />
						{
							data.error &&
			...
			return (
				<div className="formdiv">
					<label className="labeltxt">{data.labelname} {this.props.required && <span className="text-danger">*</span>}</label>
					<div>
						<input className="brdrcls" min="0" value={this.props.value} type="number" onChange={(e) => this.props.changeData && this.props.changeData(e.target.value)} onKeyDown={e => (e.key === "e"  || e.key === "+" || e.key === "-") && e.preventDefault()} />
						{
							data.error &&
							<div className="Errormsg">
								<span>{data.errmsg}</span>
			...
			return (
				<div className="formdiv">
					...
					<div>
						<textarea className={this.props.className ? this.props.className : "brdrcls"} rows="3" cols="50"  value={this.props.value} onChange={(e) => this.props.changeData && this.props.changeData(e.target.value)}></textarea>
						{
							data.error &&
							<div className="Errormsg">
								<span>{data.errmsg}</span>
